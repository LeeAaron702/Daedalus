...
const ConverLetterGeneratorPage = () => {
  ...
  const downloadCoverLetter = () => {
    const fileName = `CoverLetter_${new Date().toISOString().slice(0, 10)}_${generatedCoverLetter.slice(0, 10)}.txt`;
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="mb-2">
                  <FormControl label="Job Description">
                    <textarea
                      className="resize-vertical border rounded-md p-2 w-full"
